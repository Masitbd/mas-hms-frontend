  ...
  const generateHospitalBillPDF = () => {
    ...
    groupedServices.forEach((group: any) => {
      ...
      group.services.forEach((service: any) => {
        serviceRows.push([
          ...
          { text: service.serviceAmount.toFixed(2) },
          { text: service.quantity },
          { text: isFixedBill ? "0.00" : service.total.toFixed(2) },
        ]);
      });
    });
    ...
    if (general) {
      serviceRows.push([
        { text: "General Charge" },
        { text: new Date(admissionDate).toLocaleDateString("en-GB") },
        { text: isFixedBill ? "0.00" : general.toFixed(2) },
        { text: "1" },
        { text: isFixedBill ? "0.00" : general.toFixed(2) },
      ]);
    }
    ...
    if (bedCharge) {
      serviceRows.push([
        { text: "Bed Charge" },
        { text: new Date(admissionDate).toLocaleDateString("en-GB") },
        { text: isFixedBill ? "0.00" : bedCharge.toFixed(2) },
        { text: "1" },
        { text: isFixedBill ? "0.00" : bedCharge.toFixed(2) },
      ]);
    }
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                {},
                {},
                { text: totalPaid.toFixed(2), bold: true, fontSize: 12 },
              ],
              [
                {
                  text: "Due Amount",

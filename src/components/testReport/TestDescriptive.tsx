...
const TestDescriptive = ({ reportGenerate, setReportGenerate, setReportGenerateModal }: ITestReportForm) => {
    ...
    return (
        <div>
            ...
            <Message closable showIcon type="warning" header="Do you want edit first?">
            ...
            {docxContents && (<div className='bg-gray-100 rounded p-4 editor'>

                <EditorProvider slotBefore={(<MenuBar />)} extensions={extensions} content={content} ><></></EditorProvider>
            </div>)}

            <Button appearance="default" className='ml-5 mt-10' onClick={handleSave}>Save</Button>
            <Button appearance="default" disabled={false} className='ml-5 mt-10' onClick={() => {
